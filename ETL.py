...
SELECT
    ...
    co.exchangeRate AS tipoCambioUSD,
...
def asegurarColumnaNumerica(dataFrame, nombreColumna):
    ...
    dataFrame[nombreColumna] = dataFrame[nombreColumna].fillna(0.0)
...
try:
    ...
    for nombreColumna in columnasTexto:
        resultadoFinal[nombreColumna] = resultadoFinal[nombreColumna].replace(0, None)
