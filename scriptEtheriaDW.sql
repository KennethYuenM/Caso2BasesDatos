...
CREATE TABLE centroAnalisis (
    ...
    -- MARCA Y SITIO (aplica para Dynamic Brands)
    ...
    -- GEOGRAFIA
    paisOrigen VARCHAR(50),                                -- pais del proveedor/origen del producto
    codigoIsoPaisOrigen VARCHAR(10),
    paisDestino VARCHAR(50),                               -- pais donde se vende/importa
    codigoIsoPaisDestino VARCHAR(10),

    -- CLIENTE (aplica para Dynamic Brands)
    idClienteOrigen INT,
    ...
    -- METRICAS DEL SITIO (al momento de la venta)
